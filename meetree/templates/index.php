...
<div id="meetree-app" data-version="1.1.22">
    <aside class="meetree-sidebar">
        ...
        <div id="meetree-open-menu" class="meetree-file-actions" hidden>
            ...
            <input id="meetree-import-file" type="file" accept=".mtre,.hjt,.ctd,.json,.txt,text/plain,application/json,application/xml" />
        </div>
    ...
    <main class="meetree-editor">
        <div class="meetree-editor-toolbar">
            ...
            <button type="button" id="meetree-edit-mode" class="meetree-mode-button" aria-pressed="false" title="Switch to edit mode">Edit</button>
    ...
    <section id="meetree-search-panel" class="meetree-search-panel" hidden>
        ...
        <div class="meetree-search">
            ...
            <div class="meetree-search-options">
                ...
                <label><input id="meetree-search-branch" type="checkbox" /> Current branch only</label>
            </div>
            <div class="meetree-search-replace">
                ...
                <button type="button" id="meetree-replace-all">Replace all matches</button>
            </div>
            <p id="meetree-search-status" class="meetree-search-status">Scope: whole tree.</p>
